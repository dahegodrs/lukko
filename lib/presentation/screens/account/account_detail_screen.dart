...
class AccountDetailScreen extends StatelessWidget {
  ...
  const AccountDetailScreen({super.key, required this.cuentaIndex});
  ...
  Widget build(BuildContext context) {
    return Consumer<CuentasProvider>(
      builder: (context, provider, child) {
        final cuenta = provider.cuentas[cuentaIndex];
            ...
            onTap: (index) async {
              switch (index) {
                case 0:
                  ...
                  break;
                case 1:
                  final nuevaCuenta = await Navigator.push(
                    context,
                    MaterialPageRoute(
                ...
                case 2:
                  Navigator.pushNamed(
                    context,
                    AppRouter.addOrEditMovimiento,
                    arguments: {
                      'cuentaIndex': cuentaIndex,
                      'movimiento': null,
                      'movimientoIndex': null,
                    },
                  );
                  break;
              }
